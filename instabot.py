...
bot = InstaBot(
    login="login_do_insta",
    password="senha_do_insta",
    like_per_day=1000, #Aumente por sua conta e risco
    comments_per_day=0,
    tag_list=['ensaio', 'ensaiobh', 'ensaiofeminino', 'grandebh', 'belohorizonte', 'minasgerais',
              'ruivasbh', 'olhoazul', 'clubedosretratos', 'noivos', 'noiva', 'casamento',
              'portrait', 'euamoclicar', 'euamoclicarbh', 'loirasbh', 'ensaioartistico',
